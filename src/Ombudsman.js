        ...
        <div className="ombudsman-options" style={{ marginTop: '20px' }}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input
                    ...
                    onChange={(e) => {
                    const re = /^[0-9\b]+$/; 
                        if (e.target.value === '' || re.test(e.target.value)) {setTelephone(e.target.value);
                        }
                    }}
                    pattern="[0-9]*" 
                ...
                <select
                    ...
                    >
                    <option value="">Select an occupation</option>
                    <option value="Complaint">Complaint with Proof</option>
                ...
                <select
                    ...
                    >
                    <option value="">Select an character</option>
                    <option value="Confidential">Confidential on Request</option>
